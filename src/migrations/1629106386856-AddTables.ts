...
export class AddTables1629106386856 implements MigrationInterface {
  name = "AddTables1629106386856";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "block" ("blockHash" character varying NOT NULL, "chainId" character varying NOT NULL, "blockTime" character varying NOT NULL, "blockNumber" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ce8d7e169def9583aefa21760f3" PRIMARY KEY ("blockHash"))`
    );
    await queryRunner.query(
