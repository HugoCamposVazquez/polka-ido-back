...
export class AddTables1629466750853 implements MigrationInterface {
  name = "AddTables1629466750853";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "saleContract" ("id" character varying NOT NULL, "address" character varying NOT NULL, "chainId" integer NOT NULL, "blockHash" character varying NOT NULL, CONSTRAINT "PK_cf5c84ec5f44ca7f2d622a276c4" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
